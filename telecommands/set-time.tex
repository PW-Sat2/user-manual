...
\begin{itemize}
	...
	\item In case of major clock skews analyze time source measurements as it may indicating MCU clock/MCU RTC/external RTC failure. See \nameref{tc:SetTimeCorrectionConfig} for more information on how to disable RTCs.
\end{itemize}
