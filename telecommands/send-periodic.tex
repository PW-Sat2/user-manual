...
\begin{itemize}
	\item \warn{Requesting more than 40 frames will trigger \todo{COMM Hang Prevention System} that will cause COMM reset and resetting queue of frames to be send. That may cause communication data loss.}
