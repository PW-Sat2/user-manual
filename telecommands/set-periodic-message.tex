...
Before enabling periodic message make sure that enough power can be provided. See \procref{Periodic message} for more details regarding periodic message functionality.
