...
Deployment disabled flag is set immediately in \todo{Persistent State} and prevents any further deployment steps from executing. Deployment is not resumed after \OBC restart.
...
Correlated success response frame is of type \texttt{StopAntennaDeploymentSuccessFrame} and contains single byte with value 0. If this frame is sent, change of deployment flag was successfully saved in \todo{Persistent State}.
