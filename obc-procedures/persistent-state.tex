...
\begin{longtable}{l|l|m{6cm}|l}
    ...
    \hline
    MessageState & \parbox[c]{5cm}{interval \\ repeatCount \\ message} & See the \procref{Periodic message} section for the details regarding periodic message configuration & \parbox[c]{1cm}{8\\8\\1600} \\
    \bottomrule
\end{longtable}
