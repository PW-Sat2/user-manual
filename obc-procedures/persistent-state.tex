...
\begin{tabular}{l | l | m{6cm} | l}
    ...
    \hline
    MessageState & \parbox[c]{5cm}{interval \\ repeatCount \\ message} & See the \procref{Periodic message} for the details regarding periodic message configuration & \parbox[c]{5cm}{8\\8\\1600} \\
    \hline
\end{tabular}